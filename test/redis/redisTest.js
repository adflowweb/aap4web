...
describe('redis test', function () {
    ...
    it('"test001/index.js":"1234567890" 생성 테스트 : 응답코드 200', function (done) {

        var value = "1234567890";
        var key = '/test001/index.js';
...
//    });
    ...
    it('"/test001/index.js" 가져오기 테스트 : 응답 1234567890', function (done) {
        var key = 'test001/index.js';
        request(url)
            .get('/v1/redis/' + key)
            // end handles the response
    ...
    it('"/test001/index.js" 삭제 테스트 : 응답 deleteCount 1', function (done) {
        var key = '/test001/index.js';
        request(url)
            .del('/v1/redis' + key)
            //.send(body)
    ...
    it('get all keys 테스트 : 응답코드 200', function (done) {

        var hashKey = ['testHash'];
        request(url)
            .get('/v1/redis?keys=/test001/TestServlet')
            .send(hashKey)
            // end handles the response
            .end(function (err, res) {
                if (err) {
